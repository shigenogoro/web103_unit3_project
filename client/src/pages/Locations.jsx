...
const Locations = () => {
    ...
    const [venueNames, setVenueNames] = useState({venue1: 'taipei-arena', venue2: 'taipei-music-center', venue3: 'weiwuying', venue4: 'national-taichung-theater'})
    ...
    useEffect(() => {
        (async () => {
            try {
                ...
                // setVenueNames({venue1: locationsData[0].location, venue2: locationsData[2].location, venue3: locationsData[3].location, venue4: locationsData[1].location})
                setListeners()
            }
            catch (error) {
                throw error
    ...
    return (
        <div className='available-locations'>
            ...
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000.32 500" xmlSpace="preserve">
                ...
                <a href='/taipei-arena'><polygon id="venue1" points="2.97,234.52 17.94,198.9 34.45,188.58 52.52,191.68 56.65,196.32 69.03,162.26 84,137.48 
                ...
                <a href='/taipei-music-center'><polygon id="venue2" name='venue2' value={2} points="358.58,353.74 376.65,322.77 389.55,314.52 384.39,280.45 407.61,272.19 422.06,220.58 
                ...
                <a href='/weiwuying'><polygon id="venue3" name='venue3' value={3} points="998.06,83.81 952.65,31.16 914.45,16.71 877.29,43.55 833.94,102.39 811.74,161.23 
                796.77,241.23 802.97,303.16 833.94,353.23 871.61,385.23 954.71,385.23 1000.32,387.81 " /></a>

                <a href='/national-taichung-theater'><polygon id="venue4" name='venue4' value={4} points="625,291 615,305 608,318 625,338 637,354 622.5,358 673,363.5 751,363.5 793,363.5 
